    ...
    <div class="mx-auto max-w-5xl p-4 sm:p-6">
      ...
      <div class="space-y-5">
        ...
        <div>
          ...
          <div ref="pickerEl" class="mt-1 h-[60vh] min-h-[360px] w-full overflow-hidden rounded-lg ring-1 ring-slate-200"></div>
          <p class="mt-1 text-xs text-slate-500">
            Vyhľadaj miesto v poli vyššie, alebo klikni priamo do mapy a nastav značku.
          </p>
